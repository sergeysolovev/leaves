...
namespace AbcLeaves.Core
{
    public class HttpBackchannel : IHttpBackchannel
    {
        ...
        public static HttpBackchannel Create(HttpMessageHandler httpMessageHandler)
        {
            return new HttpBackchannel(httpMessageHandler);
        }

        private HttpBackchannel(HttpMessageHandler httpMessageHandler)
        {
